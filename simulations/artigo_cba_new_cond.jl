...
plot_vertices(F, p[3] for p in v)
...
begin
	plt_sul, traj_sul = pipe_trajectory(F, A_exp, B_exp, E_exp, G, d, 5.0,v_sorted[31915], passos=200)
...
begin
	plt_norte, traj_norte = pipe_trajectory(F, A_exp, B_exp, E_exp, G, d, 5.0,v_sorted[13492], passos=200)
...
begin
	_, traj_leste = pipe_trajectory(F, A_exp, B_exp, E_exp, G, d, 5.0,v_sorted[43616], passos=300)
...
begin
	_, traj_oeste = pipe_trajectory(F, A_exp, B_exp, E_exp, G, d, 5.0,v_sorted[37], passos=300)
...
# ╔═╡ a9207e57-e457-48bd-aa9a-51ab9228e981
v_sorted_rev = sort(v; by = x -> x[1][1])

# ╔═╡ 852129c2-42bb-44e4-a001-cb297eebfe3f
plot_vertices(F, p[1] for p in v)

# ╔═╡ f0eface9-f498-4d81-a6fd-543dc5116272
@bind i_rev Slider(1:size(v_sorted_rev, 1), show_value=true)

# ╔═╡ cb1a1100-445f-47de-8b12-8d1b9425eda0
plot_vertices(F, [v_sorted_rev[i_rev][1]])

# ╔═╡ b6239230-9443-49ee-ab2b-546dcef337df
begin
	_, traj_rev = pipe_trajectory(F, A_exp, B_exp, E_exp, G, d, 5.0,reverse(v_sorted_rev[43616]), passos=200)
	plt_rev, traj_rev = pipe_trajectory(F, A_exp, B_exp, E_exp, G, d, -5.0,traj_rev, passos=300)
end
